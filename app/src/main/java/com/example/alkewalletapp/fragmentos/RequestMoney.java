 ...
 * Use the {@link RequestMoney#newInstance} factory method to
...
public class RequestMoney extends Fragment {
    ...
    public static RequestMoney newInstance(String param1, String param2) {
        RequestMoney fragment = new RequestMoney();
